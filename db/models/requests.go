...
type Request struct {
	...
	AntID           int64            `boil:"ant_id" json:"ant_id" toml:"ant_id" yaml:"ant_id"`
...
var RequestWhere = struct {
	...
	AntID:           whereHelperint64{field: "\"requests\".\"ant_id\""},
...
func FindRequest(ctx context.Context, exec boil.ContextExecutor, iD int, timestamp time.Time, selectCols ...string) (*Request, error) {
	requestObj := &Request{}
	...
	query := fmt.Sprintf(
		"select %s from \"requests\" where \"id\"=$1 AND \"timestamp\"=$2", sel,
	)
...
func (o *Request) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	...
	if !cached {
		...
		update = strmangle.SetComplement(update, requestGeneratedColumns)
...
func (o *Request) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"requests\" WHERE \"id\"=$1 AND \"timestamp\"=$2"
...
func (o *Request) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindRequest(ctx, exec, o.ID, o.Timestamp)
	if err != nil {
		return err
	}
...
func RequestExists(ctx context.Context, exec boil.ContextExecutor, iD int, timestamp time.Time) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"requests\" where \"id\"=$1 AND \"timestamp\"=$2 limit 1)"
